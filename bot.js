...
**${PREFIX}play** - YouTube تشغيل أغنية من .\n\
**${PREFIX}skip** - لتخطي الاغنية.\n\
**${PREFIX}stop** - لأيقاف الاغنيه.\n\
**${PREFIX}volume** - تغير شده الصوت .\n\
**${PREFIX}np** - عرض الاغنيه المشغله حاليا.\n\
**${PREFIX}queue** - يعطيك قائمة الاغاني التي تم تشغيلها.\n\
**${PREFIX}pause** - لتوقيف الموسيقى لكن البوت سيبقى بالروم الصوتيه .\n\
**${PREFIX}resume** - لاكمال الموسيقى الموقوفه.`
              }
            ],
            timestamp: new Date(),
            footer: {
...
client.on('message', message => {
  ...
  if (message.author.id !== "511828969360850965") return;
